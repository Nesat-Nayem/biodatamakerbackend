...
exports.siteSecurityRouter = void 0;
const express_1 = __importDefault(require("express"));
const site_security_controller_1 = require("./site-security.controller");
...
router.get('/', site_security_controller_1.getSiteSecurity);
/**
 * @swagger
 * /v1/api/site-security:
 *   put:
...
router.put('/', (0, authMiddleware_1.auth)('admin'), site_security_controller_1.updateSiteSecurity);
exports.siteSecurityRouter = router;
