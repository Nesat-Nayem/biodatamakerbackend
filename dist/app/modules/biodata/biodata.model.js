...
const SectionsSchema = new mongoose_1.Schema({}, { strict: false, _id: false });
const BiodataSchema = new mongoose_1.Schema({
    title: { type: String, trim: true },
    godName: { type: String, trim: true },
    sections: { type: mongoose_1.Schema.Types.Mixed, required: true },
...
exports.Biodata = mongoose_1.default.model('Biodata', BiodataSchema);
